...
*/
#define PH_COLOR_VERSION_MINOR 4
...
@return Returns PV_OK (TRUE) on success, PV_FAIL (FALSE) otherwise.
*/
rs_bool PV_DECL ph_color_context_create(
        ph_color_context** pContext);
/** For loading #ph_color_context_create at run-time. */
typedef rs_bool (PV_DECL *ph_color_context_create_fn)(
        ph_color_context** pContext);
/** For loading #ph_color_context_create at run-time. */
...
@return Returns PV_OK (TRUE) on success, PV_FAIL (FALSE) otherwise.
*/
rs_bool PV_DECL ph_color_context_apply_changes(
        ph_color_context* pContext);
/** For loading #ph_color_context_apply_changes at run-time. */
typedef rs_bool (PV_DECL *ph_color_context_apply_changes_fn)(
        ph_color_context* pContext);
/** For loading #ph_color_context_apply_changes at run-time. */
...
@return Returns PV_OK (TRUE) on success, PV_FAIL (FALSE) otherwise.
*/
rs_bool PV_DECL ph_color_auto_exposure_abort(
        const ph_color_context* pContext);
/** For loading #ph_color_auto_exposure_abort at run-time. */
typedef rs_bool (PV_DECL *ph_color_auto_exposure_abort_fn)(
        const ph_color_context* pContext);
/** For loading #ph_color_auto_exposure_abort at run-time. */
...
typedef rs_bool (PV_DECL *ph_color_auto_exposure_and_white_balance_fn)(
        const ph_color_context* pContext, int16 hcam, rgn_type roi,
        uns32* pExpTime, flt32* pRedScale, flt32* pGreenScale,
        flt32* pBlueScale);
/** For loading #ph_color_auto_exposure_and_white_balance at run-time. */
...
@return Returns PV_OK (TRUE) on success, PV_FAIL (FALSE) otherwise.
*/
rs_bool PV_DECL ph_color_convert_format(
        uns16 width, uns16 height,
...
typedef rs_bool (PV_DECL *ph_color_convert_format_fn)(
        uns16 width, uns16 height,
        const void* pFromBufRgb, int32 fromRgbFormat, uns16 fromBitDepth,
        void* pToBufRgb, int32 toRgbFormat, uns16 toBitDepth);
/** For loading #ph_color_convert_format at run-time. */
